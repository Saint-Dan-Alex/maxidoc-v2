...
class MyPagination extends Collection implements Arrayable, ArrayAccess, Countable, IteratorAggregate, Jsonable, JsonSerializable //, LengthAwarePaginatorContract
{
    /**
    ...
    {
        // $class = (\Illuminate\Contracts\Pagination\LengthAwarePaginator::class) $this;
        $window = UrlWindow::make(
            new LengthAwarePaginator(
                $this->items, $this->total, $this->perPage));
