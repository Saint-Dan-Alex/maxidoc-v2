...
class Sortants extends Component
{
    ...
    public function render()
    {
        ...
        $courriers = Courrier::where('type_id', 2)->where('statut_id', '!=', 3);
        ...
        return view('livewire.dashboard.courriers.sortants', compact('courriers'));
    }
