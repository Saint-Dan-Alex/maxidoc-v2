...
@section('content')
    <div class="card card-lg">
        <div class="text-star">
            <h1 class="text-star-title">Division</h1>
    ...
    <div class="container-fluid px-lg-2 block-top-margin">
        ...
        <div class="mt-2 row g-lg-3">
            <div class="col-lg-12">
                @livewire('systems.division', ['divisions' => $divisions])
            </div>
        </div>
    </div>

    @foreach ($divisions->get() as $division)
        <div class="modal fade" id="modal-edit-division-{{ $division->id }}" tabindex="-1"
            aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title d-flex align-items-center" id="exampleModalLabel">
                            <span>Modifier un division</span>
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('regidoc.divisions.update', $division->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="libelle" class="form-control"
                                        value="{{ $division->libelle }}" placeholder="Nom du division" required>
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <select name="direction_id" class="form-control select2Bis" required
                                        ...
                                        @foreach ($directions as $direction)
                                            <option value="{{ $direction->id }}" @selected($division->direction_id == $direction->id)>
                                ...
                                <div class="col-lg-12" wire:ignore>
                                    ...
                                    <select name="responsable_id" class="form-control select2" required
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" @selected($division->responsable_id == $user->id)>
                                                {{ $user->name }} </option>
                                        @endforeach --}}
                                    </select>
                                </div>
                                {{-- <div class="col-lg-12">
                                    ...
                                    <textarea name="description" class="form-control" cols="30" rows="5"> {{ $division->description }} </textarea>
                                </div> --}}
                                {{-- <div class="col-lg-12">
                                    ...
                                    <select name="statut_id" class="form-control" required>
                                        ...
                                        @foreach ($statuts as $statut)
                                            <option value="{{ $statut->id }}" @selected($division->statut_id == $statut->id)>
    ...
    <div class="modal fade" id="modal-new-division" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title d-flex align-items-center" id="exampleModalLabel">
                ...
                <div class="modal-body">
                    <form action="{{ route('regidoc.divisions.store') }}" method="POST">
                        ...
                        <div class="form-group row g-4">
                            <div class="col-lg-12">
                                <label for="">Titre</label>
                                <input type="text" name="libelle" class="form-control" placeholder="Nom du division"
                                    required>
                            </div>
                            <div class="col-lg-12">
                                <label for="">Direction</label>
