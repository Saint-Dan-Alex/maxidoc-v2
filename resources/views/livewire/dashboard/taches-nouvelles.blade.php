    ...
    <div class="card card-table px-0">
        <div class="row px-lg-3 px-2 align-items-center g-2">
            <div class="col-lg-7 col-sm-6">
                <h4 class="title-card">Nouvelles tâches</h4>
            </div>
                        ...
                        @forelse ($taches as $tache)
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <div class="box-avatar d-flex align-items-center">
                                        {{-- @foreach ($tache->executants as $executant)
                                            <div class="avatar-team cursor-pointer">
                                                <div class="tooltip-team">
                                                    {{ $executant->prenom }} {{ $executant->nom }}
                                                </div>
                                                <img src="{{ imageOrDefault($executant->image) }}" alt="">
                                            </div>
                                            @if (count($tache->executants) == 1)
                                                <span class="name">
                                                    {{ $executant->prenom }} {{ $executant->nom }}
                                                </span>
                                            @endif
                                ...
                                <td>
                                    <div @class([
                                        'badge',
                                        'badge-yellow' => $tache->statut_id == 2,
                                        'badge-gray' => $tache->statut_id == 1,
                                        'badge-yellow' => $tache->statut_id == 3,
                                    ])>
                                        {{ $tache->statut?->titre }}
                                    </div>
                                </td>
