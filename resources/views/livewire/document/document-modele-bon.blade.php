<div class="inner-letter admin" id="doc_save" wire:poll.keep-alive
    ...
    <div class="block-header">
        <div class="row g-lg-4 g-3 mt-1">
            <div class="col-7">
                ...
                <p style="color:black; margin-bottom: 0; margin-top: 7px;font-size: 14px">N° d'impôt :
                    {{ $impot }} </p>
            </div>
            <div class="col-5">
                <p style="text-transform: uppercase; color:black; margin-bottom: 0;font-size: 14px">
                    {{ $rue ?? 'Boulevard du 30 juin' }}
                </p>
                <p style="text-transform: uppercase; color:black; margin-bottom: 0;font-size: 14px">
                    N°{{ $num ?? '59-63, Kinshasa I' }}
                </p>
                <p style="color:black; margin-bottom: 0;font-size: 14px">B.P.{{ $bp ?? '12599' }} id. Nat.
                    {{ $idnat ?? '01-D3501-A 01918K' }}</p>
                <p style="color:black; margin-bottom: 0;font-size: 14px">Téléphone : {{ $phone ?? '(+243) 810800890' }}
                </p>
                <p style="color:black; margin-bottom: 0;font-size: 14px">E-mail :
                    {{ $email ?? 'courrier@regidesordc.com' }}</p>
            </div>
            <div class="col-10 text-end">
                <div class="title-table"
                    style="display: inline-block;color:black;font-size: 20px;font-family: 'Roboto-bold';">
                    Bon de Commande <span
                        style="font-style: italic; font-size: 16px">{{ $bon ?? 'N°/ 10100/044/2023' }}</span>
                </div>
            </div>
            <div class="col-8">
                <p style="color:black; margin-bottom: 0;font-size: 14px">Nom Fournisseur :
                    {{ $fournisseur ?? 'DAKOTA AVIATION' }}</p>
            </div>
            <div class="col-9 text-end">
                <p style="color:black; margin-bottom: 0; font-size: 14px">DATE : {{ $date ?? 22 / 04 / 2023 }}</p>
            </div>
            <div class="col-12">
                <p style="color:black; margin-bottom: 0;font-size: 14px">Adresse :
                    {{ $location ??
                        'Av. MILITANT, AIROPORT DE NDOLO KIN
                                                                                                                                                                RDC' }}
                </p>
            </div>
        </div>
    ...
    <div class="block-body" style="margin-top: 30px;">
        <div class="content-text-letter">
            ...
            <tbody class="tbodyContent" wire:ignore>
                <tr class="row-table" wire:ignore>
                    <td>
                    ...
                    <td colspan="2">
                        <div class="block-add-row" style="height: 100%;position: relative;">
                            <textarea name="" id="" cols="30" rows="2" class="form-control p-0"
                                style="border:none;font-size: 14px; color: black;background: #fff!important; text-align: end;resize: vertical;"></textarea>
                            <a href="javascript:void()" class="btn-add-row" id="btn-add-row" wire:click='addRow'
            ...
            <tbody>
                <tr>
                    <td colspan="6"
                        style="text-align: center; color: black;font-family: 'Roboto-bold';vertical-align: middle">
                        TOTAL GENERAL TTC
                    </td>
                    <td colspan="3">
                        <textarea name="" id="" cols="30" rows="2" class="form-control p-0"
        ...
        <p style="color:black; margin-bottom: 0;font-size: 14px; margin-top: 10px">Nous disons : Dollars américains
            Cent quatre vingt deux mille sept cents.</p>
        <div class="block-signateurs">
            <div class="row g-3 g-lg-4 justify-content-end my-5">
                <div class="col-6">
